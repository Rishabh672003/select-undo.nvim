        ...
        for i = #undo_tree.entries, 1, -1 do
            ...
            if length_diff == 1 then -- Character was deleted
                ...
                if in_deletion_sequence and deletion_count > 1 then
                    ...
                    while
                        pre_word_start > 1
                        and pre_deletion_line:sub(pre_word_start - 1, pre_word_start - 1):match("[%w_]")
                    do
                        pre_word_start = pre_word_start - 1
                    end
                    while
                        pre_word_end <= #pre_deletion_line
                        and pre_deletion_line:sub(pre_word_end, pre_word_end):match("[%w_]")
                    do
